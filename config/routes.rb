Rails.application.routes.draw do
  ...
  get 'app/materias_educacion_media' => 'visualizaciones#materias_educacion_media', :as => :app_materias_educacion_media
  ...
  post 'app/service_actualizaciones_actualizacion_geometrias' => 'service_actualizaciones#actualizacion_geometrias', :as => :app_service_actualizaciones_actualizacion_geometrias
  post 'app/service_actualizaciones_generar_csv_json' => 'service_actualizaciones#generar_csv_json', :as => :app_service_actualizaciones_generar_csv_json
