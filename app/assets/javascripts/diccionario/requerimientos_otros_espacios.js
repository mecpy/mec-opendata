    ...
    var diccionario = [
        {
            ...
            descripcion: 'Corresponde al nombre del espacio que la institución está requiriendo como construcción nueva, a reparar o a adecuar. Ejemplos son: dirección, laborario',
            tipo: 'xsd:string',
            restricciones: '',
            referencia: {
                texto: '',
            ...
            descripcion: 'Corresponde a la cantidad del espacio físico a construir, a reparar, o a adecuar (dependiendo del tipo de requerimiento) requeridas por la institución educativa',
            tipo: 'xsd:positiveInteger',
            restricciones: '',
            referencia: {
                texto: '',
