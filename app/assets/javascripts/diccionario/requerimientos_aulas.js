    ...
    var diccionario = [
        {
            ...
            descripcion: 'Corresponde a la cantidad de aulas a construir, a reparar, o a adecuar (dependiendo del tipo de requerimiento) requeridas por la institución educativa',
            tipo: 'xsd:positiveInteger',
            restricciones: '',
            referencia: {
                texto: '',
