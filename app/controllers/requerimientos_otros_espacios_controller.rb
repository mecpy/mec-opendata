class RequerimientosOtrosEspaciosController < ApplicationController
  ...
  def lista
    ...
    if params[:form_buscar_requerimientos_otros_espacios][:cuenta_espacio_para_construccion].present?

      cond << "cuenta_espacio_para_construccion = ?"
      args << "#{params[:form_buscar_requerimientos_otros_espacios][:cuenta_espacio_para_construccion]}"
