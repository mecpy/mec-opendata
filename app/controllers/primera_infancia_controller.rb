class PrimeraInfanciaController < ApplicationController
  ...
  def index
    ...
    @establecimientos = Establecimiento.por_primera_infancia.orden_dep_dis.paginate :per_page => 15, :page => params[:page]
  ...
  def lista
    ...
    if params[:ordenacion_columna].present? && params[:ordenacion_direccion].present?
      @establecimientos = Establecimiento.por_primera_infancia.order(params[:ordenacion_columna] + " " + params[:ordenacion_direccion]).where(cond).paginate(page: params[:page], per_page: 15)
    else
      @establecimientos = Establecimiento.por_primera_infancia.orden_dep_dis.where(cond).paginate(page: params[:page], per_page: 15)
    end

    @total_registros = Establecimiento.por_primera_infancia.count 

    if params[:format] == 'csv'

      require 'csv'

      establecimientos_csv = Establecimiento.por_primera_infancia.orden_dep_dis.where(cond)
      ...
      if params[:ordenacion_columna].present? && params[:ordenacion_direccion].present?
        establecimientos_xlsx = Establecimiento.por_primera_infancia.order(params[:ordenacion_columna] + " " + params[:ordenacion_direccion]).where(cond)
      else
        establecimientos_xlsx = Establecimiento.por_primera_infancia.orden_dep_dis.where(cond)
      end
      ...
      if params[:ordenacion_columna].present? && params[:ordenacion_direccion].present?
        establecimientos = Establecimiento.por_primera_infancia.order(params[:ordenacion_columna] + " " + params[:ordenacion_direccion]).where(cond)
      else
        establecimientos = Establecimiento.por_primera_infancia.orden_dep_dis.where(cond)
      end
      ...
      if params[:ordenacion_columna].present? && params[:ordenacion_direccion].present?
        @establecimientos_todos = Establecimiento.por_primera_infancia.order(params[:ordenacion_columna] + " " + params[:ordenacion_direccion]).where(cond)
      else
        @establecimientos_todos = Establecimiento.por_primera_infancia.orden_dep_dis.where(cond)
      end
  ...
  def primera_infancia_ubicacion_geografica

    @establecimiento = Establecimiento.por_primera_infancia.find(params[:id])
  ...
  def primera_infancia_ubicaciones_geograficas
