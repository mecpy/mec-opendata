...
class Establecimientos822Controller < ApplicationController
  ...
  def lista
    ...
    @establecimientos = cond.size > 0 ? (Establecimiento822.orden_dep_dis.paginate :conditions => cond, :per_page => 15, :page => params[:page]) : {}
    ...
    if params[:format] == 'csv'
      ...
      establecimientos_csv = Establecimiento822.orden_dep_dis.find(:all, :conditions => cond)
      ...
      @establecimientos = Establecimiento822.orden_dep_dis.find(:all, :conditions => cond)
      ...
      respond_to do |format|
        ...
        format.xlsx {
          ...
          columnas = [:anio, :codigo_institucion, :codigo_establecimiento_, :codigo_departamento, :nombre_departamento, :codigo_distrito, :nombre_distrito, :codigo_zona, :nombre_zona, :codigo_barrio_localidad,
            :nombre_barrio_localidad, :direccion, :asentamientos_priorizados, :a_comedor, :a_aulas, :a_aula_de_pe, :a_cra, :a_lab, :a_bloq_adm, :r_aulas, :r_sshh, :oe_pozo, :cercado, :oe_escindi, :uri] 
          
          send_data Establecimiento822.orden_dep_dis.where(cond).to_xlsx(:columns => columnas).to_stream.read, 
      ...
      @establecimientos_todos = Establecimiento822.orden_dep_dis.find(:all, :conditions => cond)
  ...
  def ubicaciones_geograficas
    ...
    @establecimientos = cond.size > 0 ? ( Establecimiento822.orden_dep_dis.find(:all, :conditions => cond)) : {}
